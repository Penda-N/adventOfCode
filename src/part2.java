    ...
    public static int countVisibleTrees(int[][] treesMap) {
        ...
        for (int i = 0; i < rows; i++) {
            for (int j = 0; j < cols; j++) {
                ...
                // Find scenic scores on the edge
                if (i == 0 || i == rows - 1 || j == 0 || j == cols - 1) {
                    add = 0;
                } else {

                // Find scenic scores on every direction
                    int northScore = 0;
                    int southScore = 0;
                    int estScore = 0;
                    int westScore = 0;
                    ...
                    // Determine the global scenic score for each tree
                    add = northScore * estScore * southScore * westScore;
                }
                if (add > result)
                    result = add;
